...
model.add(Conv2D(8, (3, 3), activation='relu', input_shape=(8,8,6), padding='same', kernel_regularizer=regularizerl2))
model.add(Conv2D(16, (3, 3), activation='relu', padding='same', data_format="channels_last", kernel_regularizer=regularizerl2))
model.add(Conv2D(32, (3, 3), activation='relu', padding='same', kernel_regularizer=regularizerl2))

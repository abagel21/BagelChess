# THIS HASHING COMES FROM https://github.com/venomousboxer/Chess-AI/blob/master/hasher.py
# I utilized its contents because I wanted to focus on the MTD(f) function rather than minute hashing details
import chess
...
class Hasher:
    ...
    def get_hash(self, board:chess.Board):
        return (self.get_pos_hash(board) ^ self.hash_castling(board) ^
